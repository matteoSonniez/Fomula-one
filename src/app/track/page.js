...
import BgBahrain from "@/img/track/bg-bahrain.png";
import Spa from "@/img/track/belgique.png";
import BgSpa from "@/img/track/bg-spa.png";
import France from "@/img/track/france.png";
import BgFrance from "@/img/track/bg-france.png";
import Germany from "@/img/track/germany.png";
import BgGermany from "@/img/track/bg-germany.png";
import Monza from "@/img/track/monza.png";
import BgMonza from "@/img/track/bg-monza.png";
import Brazil from "@/img/track/brazil.png";
import BgBrazil from "@/img/track/bg-brazil.png";
import Japan from "@/img/track/japan.png";
import BgJapan from "@/img/track/bg-japan.png";
import Mexico from "@/img/track/mexico.png";
import BgMexico from "@/img/track/bg-mexico.png";
import Monaco from "@/img/track/monaco.png";
import BgMonaco from "@/img/track/bg-monaco.png";
import Spain from "@/img/track/spain.png";
import BgSpain from "@/img/track/bg-spain.png";
import Singa from "@/img/track/singa.png";
import BgSinga from "@/img/track/bg-sing.png";
import Texas from "@/img/track/texas.png";
import BgTexas from "@/img/track/bg-texas.png";
      ...
      >
        ...
        <div className="w-screen h-screen flex justify-center items-center">
          <div className="grid grid-cols-4 2xl:grid-cols-5 gap-6 p-24 z-10">
            <div onMouseEnter={() => handleMouseEnter(BgGermany.src)} className="cursor-pointer">
              <img src={Germany.src} alt="Germany"></img>
            </div>
            <div onMouseEnter={() => handleMouseEnter(BgMonza.src)} className="cursor-pointer">
              <img src={Monza.src} alt="Monza"></img>
            </div>
            <div onMouseEnter={() => handleMouseEnter(BgSpa.src)} className="cursor-pointer">
              <img src={Spa.src} alt="Spa"></img>
            </div>
            <div onMouseEnter={() => handleMouseEnter(BgFrance.src)} className="cursor-pointer">
              <img src={France.src} alt="France"></img>
            </div>
            <div onMouseEnter={() => handleMouseEnter(BgBahrain.src)} className="cursor-pointer">
              <img src={Bahrain.src} alt="Bahrain"></img>
            </div> 
            <div onMouseEnter={() => handleMouseEnter(BgMexico.src)} className="cursor-pointer">
              <img src={Mexico.src} alt="Mexico"></img>
            </div>
            <div onMouseEnter={() => handleMouseEnter(BgBrazil.src)} className="cursor-pointer">
              <img src={Brazil.src} alt="Brazil"></img>
            </div>
            <div onMouseEnter={() => handleMouseEnter(BgJapan.src)} className="cursor-pointer">
              <img src={Japan.src} alt="Japan"></img>
            </div>
            <div onMouseEnter={() => handleMouseEnter(BgMonaco.src)} className="cursor-pointer">
              <img src={Monaco.src} alt="Monaco"></img>
            </div>
            <div onMouseEnter={() => handleMouseEnter(BgSpain.src)} className="cursor-pointer">
              <img src={Spain.src} alt="Spain"></img>
            </div>  
            <div onMouseEnter={() => handleMouseEnter(BgTexas.src)} className="cursor-pointer">
              <img src={Texas.src} alt="Texas"></img>
            </div>  
            <div onMouseEnter={() => handleMouseEnter(BgSinga.src)} className="cursor-pointer">
