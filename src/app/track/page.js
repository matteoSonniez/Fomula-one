...
export default function Home() {
  ...
  const setTrack = (trackName, image, imageSec1, imageSec2, imageSec3) => {
    setSecteur(0);
    ...
    >
      ...
      {oneTrackSelect ? (
        <div
          ...
          className={`text-white absolute bottom-40 flex flex-col left-14 ${
          ...
          <div className="text-[23px] ml-[3px] -mt-2">
            ...
            >
              <div
                ...
                className="border-slate-400 hover:border-white border-2 rounded-xl py-1 px-4 cursor-pointer flex space-x-2 items-center"
              >
                <text>secteur&nbsp;1</text>
                <img
                  src={Down.src}
        ...
        <div className="w-screen h-screen flex justify-center items-center">
          <div className="grid grid-cols-4 2xl:grid-cols-5 gap-6 p-24 z-10">
            <div
              ...
              onClick={() => setTrack("Germany", BgGermany, GermanySec1, GermanySec2, GermanySec3)}
            ...
            <div
              ...
              onClick={() => setTrack("Monza", BgMonza, MonzaSec1, MonzaSec2, MonzaSec3)}
              className="cursor-pointer"
            >
            ...
            <div
              ...
              onClick={() => setTrack("Belgique", BgSpa, SpaSec1, SpaSec2, SpaSec3)}
              className="cursor-pointer"
            >
            ...
            <div
              ...
              onClick={() => setTrack("France", BgFrance, FranceSec1, FranceSec2, FranceSec3)}
              className="cursor-pointer"
            >
            ...
            <div
              ...
              onClick={() => setTrack("Bahrain", BgBahrain, BahrainSec1, BahrainSec2, BahrainSec3)}
              className="cursor-pointer"
            >
            ...
            <div
              ...
              onClick={() => setTrack("Mexico", BgMexico, MexicoSec1, MexicoSec2, MexicoSec3)}
              className="cursor-pointer"
            >
            ...
            <div
              ...
              onClick={() => setTrack("Brazil", BgBrazil, BrazilSec1, BrazilSec2, BrazilSec3)}
              className="cursor-pointer"
            >
            ...
            <div
              ...
              onClick={() => setTrack("Japan", BgJapan, JapanSec1, JapanSec2, JapanSec3)}
              className="cursor-pointer"
            >
            ...
            <div
              ...
              onClick={() => setTrack("Monaco", BgMonaco, MonacoSec1, MonacoSec2, MonacoSec3)}
              className="cursor-pointer"
            >
            ...
            <div
              ...
              onClick={() => setTrack("Spain", BgSpain, SpainSec1, SpainSec2, SpainSec3)}
              className="cursor-pointer"
            >
            ...
            <div
              ...
              onClick={() => setTrack("Texas", BgTexas, TexasSec1, TexasSec2, TexasSec3)}
              className="cursor-pointer"
            >
            ...
            <div
              ...
              onClick={() => setTrack("Singapour", BgSinga, SingaSec1, SingaSec2, SingaSec3)}
              className="cursor-pointer"
            >
